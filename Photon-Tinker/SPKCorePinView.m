...
- (id)init
{
    if (self = [super init]) {
        ...
        [_bigBarLabelLayer setFont:@"Gotham-Medium"];
        [_bigBarLabelLayer setFontSize:16];
        _bigBarLabelLayer.foregroundColor = [[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.70] CGColor];
        _bigBarLabelLayer.bounds = CGRectMake(0.0, 0.0, BIG_BAR_LABEL_WIDTH, RADIUS);
        ...
        [_pinLabelLayer setFont:@"Gotham-Medium"];
        ...
        [_barLabelLayer setFont:@"Gotham-Medium"];
        ...
        [_stateLabelLayer setFont:@"Gotham-Book"];
...
- (void)refresh
{
    ...
    if (SPKCorePinFunctionAnalog(self.pin)) {
        ...
        if (self.pin.valueSet) {
            ...
            _stateLabelLayer.position = CGPointMake(barX, CENTER);
