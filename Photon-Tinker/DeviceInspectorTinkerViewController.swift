...
class DeviceInspectorTinkerViewController: DeviceInspectorChildViewController, PinViewDelegate, PinFunctionViewDelegate, PinValueViewDelegate {

    @IBOutlet var functionView: PinFunctionView!
    @IBOutlet var functionViewWidthConstraint: NSLayoutConstraint!
    @IBOutlet var functionViewHeightConstraint: NSLayoutConstraint!
    @IBOutlet var functionViewCenterXConstraint: NSLayoutConstraint!
    @IBOutlet var functionViewCenterYConstraint: NSLayoutConstraint!
